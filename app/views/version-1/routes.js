...
// ********************** Eligibility **********************
  ...
  router.post('/version-1/eligibility/under-21', function(req, res) {
    ...
    if (errors.length === 0) {
      if (req.body['under-21'] === "Yes") {
        res.redirect('/version-1/eligibility/domicile')
      }
      else {
  ...
  router.post('/version-1/eligibility/domicile', function(req, res) {
    var errors = []
    ...
    if (errors.length === 0) {
      if (req.body['domicile'] === "Yes") {
        ...
        res.redirect('/version-1/eligibility/cannot-apply-domicile')
      }
    }
    else {
        res.render('.//version-1/eligibility/domicile', { errors: errors })
    }
  })
...
// ************************************************************************************************************************************
  ...
  router.post('/version-1/application/number-of-applicants', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//version-1/application/number-of-applicants', { errors: errors })
      }
    }
    else {
        res.redirect('/version-1/task-list')
  ...
  // ********************** Date child moved in **********************
  router.post('/version-1/application/date-child-moved-in', function(req, res) {
    var errors = []
    if (req.body['day-moved-in'] === '' || req.body['month-moved-in'] === '' || req.body['year-moved-in'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          ...
          res.render('.//version-1/application/date-child-moved-in', { errors: errors })
        }
      }
      else {
        res.redirect('/version-1/task-list')
  ...
  router.post('/version-1/application/applicant-adoption-agency-details', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/version-1/application/applicant-other-adoption-agency')
      }
      else {
        res.render('.//version-1/application/applicant-adoption-agency-details', { errors: errors })
      }
    }
    else {
      res.redirect('/version-1/task-list')
  ...
  router.post('/version-1/application/applicant-other-adoption-agency', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-adoption-agency'] === 'yes') {
          res.redirect('/version-1/application/applicant-adoption-agency-details-2')
        }
        else {
          res.redirect('/version-1/application/child-social-worker-details')
        }
      }
      else {
        res.render('.//version-1/application/applicant-other-adoption-agency', { errors: errors })
      }
    }
    else {
        res.redirect('/version-1/task-list')
  ...
  router.post('/version-1/application/applicant-adoption-agency-details-2', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//version-1/application/applicant-adoption-agency-details-2', { errors: errors })
      }
    }
    else {
      res.redirect('/version-1/task-list')
  ...
  router.post('/version-1/application/child-social-worker-details', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//version-1/application/child-social-worker-details', { errors: errors })
      }
    }
    else {
      res.redirect('/version-1/task-list')
...
//        req.session.data.reviewStatus = 'completed'
        res.redirect('https://products.payments.service.gov.uk/pay/ba256382da5b435a81583a63b3c07375')
      }
      else {
...
// ************************************************************************************************************************************
  ...
  router.post('/version-1/x-ui/case-worker/index', function(req, res) {
