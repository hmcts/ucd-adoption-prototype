...
router.post('/r2/applicants/first-applicant-upload', function(req, res) {
  var errors = []
  ...
  if (req.body['submit-button'] === 'save-and-continue') {
    if (errors.length === 0) {
      ...
      res.render('.//r2/applicants/first-applicant-upload', { errors: errors })
    }
  }
  else {
    res.redirect('/r2/task-list')
...
router.post('/r2/applicants/second-applicant-upload', function(req, res) {
  ...
  router.post('/r2/children/child-date-birth', function(req, res) {
    ...
    if (req.body['day'] === '' || req.body['month'] === '' || req.body['year'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/r2/children/child-time-birth')
        }
        else {
  ...
  router.post('/r2/children/child-time-birth', function(req, res) {
    var errors = []
    if (req.body['child-time-birth'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/r2/children/child-gender')
        }
        else {
          res.render('.//r2/children/child-time-birth', { errors: errors })
        }
      }
      else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/child-gender', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/child-gender', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
...
//        res.redirect('/r2/children/child-occupation')
//      }
//      else {
//        res.render('.//r2//task-list', { errors: errors })
//      }
//    }
//    else if (req.body['submit-button'] === 'save-as-draft') {
//      res.redirect('/r2/task-list')
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['mother-have-address'] == 'no') {
          res.redirect('/r2/children/mother-why-no-address')
        }
        else {
...
//   if (errors.length === 0) {
//     if (req.body['submit-button'] === 'save-and-continue') {
//       res.redirect('/r2/applicants/second-applicant-gender')
//     }
//     else {
//       res.redirect('/r2/task-list')
//     }
...
// router.post('/r2/applicants/second-applicant-gender', function(req, res) {
//   var errors = []
...
//   }
//   else {
//       res.render('.//r2/applicants/second-applicant-gender', { errors: errors })
//   }
// })
