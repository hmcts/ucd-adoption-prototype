  ...
  router.post('/r2/eligibility/lived-uk', function(req, res) {
    ...
    if (errors.length === 0) {
      if (req.body['lived-uk'] === "Yes") {
        res.redirect('/r2/eligibility/do-you-need-help-with-fees')
      }
      else {
...
// ************************************************************************************************************************************
  ...
  // ********************** Applicants  **********************
  router.post('/r2/applicants/number-of-applicants', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/applicants/number-of-applicants', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/applicants/date-child-moved-in', function(req, res) {
    var errors = []
    if (req.body['day-moved-in'] === '' || req.body['month-moved-in'] === '' || req.body['year-moved-in'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          ...
          res.render('.//r2/applicants/date-child-moved-in', { errors: errors })
        }
      }
      else {
        res.redirect('/r2/task-list')
...
// ******************************************** Child's details ********************************************
  ...
  router.post('/r2/children/child-date-birth', function(req, res) {
    ...
    if (req.body['child-birth-day'] === '' || req.body['child-birth-month'] === '' || req.body['child-birth-year'] === '') {
      ...
      if (req.body['submit-button'] === 'save-and-continue') {
        if (errors.length === 0) {
          res.redirect('/r2/children/child-sex')
        }
        else {
  ...
  router.post('/r2/children/child-sex', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/child-nationality')
      }
      else {
        res.render('.//r2/children/child-sex', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/child-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/child-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/child-adoption-certificate', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/child-adoption-certificate', { errors: errors })
      }
    }
    else {
  ...
  router.post('/r2/children/mother-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/mother-alive')
      }
      else {
        res.render('.//r2/children/mother-name', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-alive', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['mother-alive'] === 'Yes') {
          res.redirect('/r2/children/mother-nationality')
        }
        else {
        ...
        res.render('.//r2/children/mother-alive', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/mother-occupation')
      }
      else {
        res.render('.//r2/children/mother-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/mother-have-address')
      }
      else {
          res.render('.//r2/children/mother-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['mother-have-address'] === 'No') {
          ...
          res.redirect('/r2/children/mother-address-postcode')
        }
      }
      else {
          res.render('.//r2/children/mother-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/mother-find-address')
      }
      else {
        res.render('.//r2/children/mother-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-find-address', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/mother-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/mother-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/mother-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/mother-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-in-certificate', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-in-certificate'] == 'No') {
          ...
          res.redirect('/r2/children/other-parent-exists')
        }
        else {
          res.redirect('/r2/children/father-name')
        }
      }
      else {
          res.render('.//r2/children/father-in-certificate', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/father-alive')
      }
      else {
        res.render('.//r2/children/father-name', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-alive', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-alive'] === 'Yes') {
          res.redirect('/r2/children/father-nationality')
        }
        else {
          req.session.data.fatherStatus = 'completed'
          res.redirect('/r2/task-list')
        ...
        res.render('.//r2/children/father-alive', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-nationality', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/father-occupation')
      }
      else {
        res.render('.//r2/children/father-nationality', { errors: errors })
      }
    }
    else if (req.body['submit-button'] === 'save-as-draft') {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-occupation', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/father-have-address')
      }
      else {
          res.render('.//r2/children/father-occupation', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['father-have-address'] == 'No') {
          ...
          res.redirect('/r2/children/father-address-postcode')
        }
      }
      else {
          res.render('.//r2/children/father-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/father-find-address')
      }
      else {
        res.render('.//r2/children/father-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-find-address', function(req, res) {
    // console.log(req.body['submit-button'])
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/father-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/father-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/father-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['father-address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/father-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-exists', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-parent-exists'] === 'Yes') {
          res.redirect('/r2/children/other-parent-name')
        }
        else {
        ...
        res.render('.//r2/children/other-parent-exists', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-name', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/other-parent-have-address')
      }
      else {
        res.render('.//r2/children/other-parent-name', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-have-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-parent-have-address'] == 'No') {
          ...
          res.redirect('/r2/children/other-parent-address-postcode')
        }
      }
      else {
          res.render('.//r2/children/other-parent-have-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-address-postcode', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/children/other-parent-find-address')
      }
      else {
        res.render('.//r2/children/other-parent-address-postcode', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-find-address', function(req, res) {
    // console.log(req.body['submit-button'])
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/other-parent-find-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-manual-address', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/other-parent-manual-address', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/other-parent-manual-address-international', function(req, res) {
    var errors = []
    if (req.body['other-parent-address-line-1'] === '') {
      errors.push({
      text: 'Enter the first line of the address',
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/other-parent-manual-address-international', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/applicant-adoption-agency-details', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/applicant-other-adoption-agency')
      }
      else {
  ...
  router.post('/r2/children/applicant-other-adoption-agency', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['other-adoption-agency'] === 'Yes') {
          res.redirect('/r2/children/applicant-adoption-agency-details-2')
        }
        else {
        ...
        res.render('.//r2/children/applicant-other-adoption-agency', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/applicant-adoption-agency-details-2', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/applicant-adoption-agency-details-2', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/child-social-worker-details', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/child-social-worker-details', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
 ...
 // ********************** Solicitor details **********************
  ...
  router.post('/r2/children/orders-placement-case-number', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      ...
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/orders-placement-court')
      }
      else {
        res.render('.//r2/children/orders-placement-case-number', { errors: errors })
      }
    }
    else {
      if (req.body['placement-case-number'] === '') {
  ...
  router.post('/r2/children/orders-placement-court', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        req.session.data.childOrderCompleted[count] = "No"
        res.redirect('/r2/children/orders-placement-date')
      }
      else {
  ...
  router.post('/r2/children/orders-placement-date', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/orders-summary')
      }
      else {
        res.render('.//r2/children/orders-placement-date', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-summary', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'continue') {
      ...
      if (errors.length === 0) {
        if (req.body['add-another'] === 'Yes') {
          res.redirect('/r2/children/orders-order-type')
        }
        else {
        ...
        res.render('.//r2/children/orders-summary', { errors: errors })
      }
    }
    else {
        res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-order-type', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        req.session.data.childOrderCompleted[count] = "No"
        res.redirect('/r2/children/orders-order-case-number')
      }
      else {
        res.render('.//r2/children/orders-order-type', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-order-case-number', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/orders-order-court')
      }
      else {
        res.render('.//r2/children/orders-order-case-number', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-order-court', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.redirect('/r2/children/orders-order-date')
      }
      else {
        res.render('.//r2/children/orders-order-court', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-order-date', function(req, res) {
    var errors = []
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/children/orders-order-date', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/orders-remove-court-order', function(req, res) {
    var occ = 0
    var errors = []
    ...
    if (errors.length === 0) {
      ...
      res.render('.//r2/children/orders-remove-order-court', { errors: errors })
    }
  })
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        if (req.body['sibling-court-order-exists'] === 'yes') {
          res.redirect('/r2/children/sibling-name')
        }
        else {
          req.session.data.siblingStatus = 'completed'
          res.redirect('/r2/task-list')
  ...
  router.post('/r2/children/sibling-name', function(req, res) {
    var errors = []
  ...
  router.post('/r2/children/sibling-change-name', function(req, res) {
    var errors = []
    if (req.body['sibling-first-names'] === '') {
      errors.push({
      text: 'Enter their first names',
    ...
    if (errors.length === 0) {
      ...
      res.render('.//r2/children/sibling-change-name', { errors: errors })
    }
  })
...
//    router.post('/r2/check-pay-and-submit/payment', function(req, res) {
  ...
  router.post('/r2/check-pay-and-submit/declaration', function(req, res) {
    ...
    if (req.body['submit-button'] === 'save-and-continue') {
      if (errors.length === 0) {
        res.redirect('/r2/check-pay-and-submit/need-help-with-fees-ref')
      }
      else {
...
// ************************************************************************************************************************************
  ...
  // ******************************************** Child's details ********************************************
  router.post('/r2/x-ui/children/child', function(req, res) {
    ...
    if (req.body['submit-button'] === 'continue') {
      ...
      res.redirect('/r2/x-ui/task-list')
    }
    else {
      res.redirect('/r2/task-list')
    }
  ...
  router.post('/r2/x-ui/children/child-with-errors', function(req, res) {
    var errors = []
    if (req.body['child-first-names'] === '') {
      errors.push({
      text: 'Enter the child\'s first names',
    ...
    if (req.body['submit-button'] === 'continue') {
      if (errors.length === 0) {
        ...
        res.render('.//r2/x-ui/children/child', { errors: errors })
      }
    }
    else {
      res.redirect('/r2/task-list')
